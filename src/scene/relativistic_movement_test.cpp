...
SceneRelativisticMovementTest::SceneRelativisticMovementTest(GLuint texture_width, GLuint texture_height, float time_scale, AVRational time_base, int max_recursion_depth)
{
